...
\begin{figure}[ht]
  ...
  \includegraphics[width=1.0\textwidth]{wim01-zusammenfassung_cramersche_regel.png}
	\caption[CRAMER'sche Regel]{AKAD WIM01 Mathematische Grundlagen, Lerneinheit 4, Seite 46}
	\label{fig01}
\end{figure}
...
\begin{figure}[ht]
  ...
  \includegraphics[width=0.3\textwidth]{200px-Logic-gate-and-de.png}
	\caption[UND Gatter]{UND Gatter \url{http://de.wikipedia.org/wiki/Logikgatter}}
	\label{und}
\end{figure}
...
\begin{figure}[ht]
  ...
  \includegraphics[width=0.3\textwidth]{Logic-gate-or-de.png}
	\caption[ODER Gatter]{ODER Gatter \url{http://de.wikipedia.org/wiki/Logikgatter}}
	\label{oder}
\end{figure}
...
\begin{figure}[ht]
  ...
  \includegraphics[width=0.3\textwidth]{Logic-gate-inv-de.png}
	\caption[NICHT Gatter]{NICHT Gatter \url{http://de.wikipedia.org/wiki/Logikgatter}}
	\label{nicht}
\end{figure}
